...
export default function Home() {
  const Features = () => {
    return (
      <section
        id="special"
        className=" dark:bg-gray-900 text-gray-900 dark:text-white px-8 md:px-15 lg:px-20 "
      >
          ...
          <div className="max-w-screen-xl flex flex-col items-center px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-20">
            <div className="max-w-xl text-center ">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-300">
                ...
                application for managing student and faculty projects,
                interests, and skills in an academic environment.
              </p>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    Profiles include information such as name, email,
                    department, semester (for students), designation (for
                    faculty), areas of interest, and skills.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    student and faculty profiles. Find common and unique
                    interests and skills among students and faculty.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">
                    Backend developed with Flask to handle data processing and
                    API endpoints. Frontend developed with React for dynamic and
